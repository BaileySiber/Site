    ...
    return (
      <div>
        <div className="Home-section">
          ...
          <p></p>
          <p></p>
          <p className="item"> Boston Globe: <a className="link" href="https://www.bostonglobe.com/metro/2018/08/09/prospects-murky-for-bill-address-campus-sexual-assault/H0JNakgfOioQceBuegBnOO/story.html">Proposed Bills</a> (leader of Every Voice Coalition)</p>
