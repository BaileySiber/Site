  ...
  render() {
    return (
      ...
      <div className="infoContainer">
        ...
        <div className="infoChunk">
          <p>
            right now, i'm serving as a two year <a href="https://www.cityleadership.harvard.edu/city-hall-fellowships"> bloomberg harvard city leadership fellow</a>, supporting oklahoma city as they launch their civic innovation team. i recently completed my masters in public policy as a <a href="https://rappaportfoundation.org/initiatives/publicpolicy/"> rappaport fellow</a> at the <a href="https://www.hks.harvard.edu/"> harvard kennedy school</a>, concentrating in social and urban policy. additionally, i serve as an advisor at <a href="https://www.thegcodehouse.com/">g&#123;code&#125;</a>, and am a happy alum of the boston foundation's <a href="https://www.tbf.org/what-we-do/strategic-focus-areas/nonprofit-effectiveness/women-of-color-leadership-circle">women of color leadership circle </a> and the city of boston's <a href="https://www.boston.gov/departments/new-urban-mechanics"> civic innovation fellowship</a>.
          </p>
        </div>

        <div className="infoChunk">
          <p>
            in my spare time, you'll find me exploring public libraries and parks, sewing, or watching vocal coach reactions on youtube.
          </p>
        </div>
